...
var Slide = React80.forwardRef(function Slide2(props, ref) {
  ...
  const childrenRef = React80.useRef(null);
  ...
  const updatePosition = React80.useCallback(() => {
...
var Drawer = React82.forwardRef(function Drawer2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiDrawer"
  });
  ...
  const mounted = React82.useRef(false);
  React82.useEffect(() => {
...
var SwipeableDrawer = React84.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  const {
    ...
    variant = "temporary"
    // Mobile first.
  } = props, ModalPropsProp = _objectWithoutPropertiesLoose(props.ModalProps, _excluded37), other = _objectWithoutPropertiesLoose(props, _excluded211);
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-W45CBAUY.js.map
